    ...
    if(otp == "" || otp == null){
      ...
      .then(
        ...
        err => {  
          ...
          //console.log(err);
          this.printmsg("Wrong OTP, please check the e-mail and try again.");
          // this.pouchserv.putErrorInPouch("signup_new_user()","Response error in component "+"PageotpComponent","'Masscryp' app the exception caught is "+JSON.stringify(err),2);
        }
      ).catch(err => {  
        this.loadingimage = false;
        //console.log(err);
        this.printmsg("Wrong OTP, please check the e-mail and try again.");
        this.pouchserv.putErrorInPouch("signup_new_user()","Catch throws error in component "+"PageotpComponent","'Masscryp' app the exception caught is "+JSON.stringify(err),1);
